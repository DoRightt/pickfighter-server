...
// clearTableCmd represents the clear-table command. It is used to delete all records from the pf_fighters and pf_fighter_stats tables.
// Expects one argument - the table name.
var clearTableCmd = &cobra.Command{
	Use:   "clear",
	Short: "Delete all records from the pf_fighters and pf_fighter_stats tables",
	Args:  cobra.ExactArgs(1),
	Run:   runClearTable,
}

// runClearTable is the function executed when the clear-table command is run.
// It deletes all records from the pf_fighters and pf_fighter_stats tables.
