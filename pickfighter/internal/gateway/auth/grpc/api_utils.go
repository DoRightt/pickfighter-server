...
// ServiceHealthCheck connects to the auth-service via gRPC to check its health status.
// It creates a new client for the auth-service, sends a HealthCheck request, and retrieves the response.
