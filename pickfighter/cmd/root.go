...
// rootCmd is the main Cobra command representing the root of the Pickfighter service.
var rootCmd = &cobra.Command{
	Use:   "Pickfighter Service",
...
// Execute runs the root command for the Pickfighter service.
