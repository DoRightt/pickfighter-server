...
ALTER TABLE ONLY fighters.fighters
    ADD CONSTRAINT fighters_name_debut_timestamp_key UNIQUE (name, debut_timestamp, fighter_url);
...
ALTER TABLE ONLY fighters.fighter_stats
    ADD CONSTRAINT fighter_stats_pkey PRIMARY KEY (stat_id);

ALTER TABLE ONLY fighters.fighter_stats
    ADD CONSTRAINT fighter_stats_fighter_id_fkey FOREIGN KEY (fighter_id) REFERENCES fighters.fighters(fighter_id);