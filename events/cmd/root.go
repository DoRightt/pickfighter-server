...
import (
	...
	"github.com/DoRightt/pickfighter-server/events/pkg/logger"
...
// rootCmd is the main Cobra command representing the root of the Events service.
var rootCmd = &cobra.Command{
	Use:   "Event Service",
	Short: "This CLI works with user bets and fight events",
...
// Execute runs the root command for the Events service.
...
func setConfigDefaults() {
	...
	// http server
	viper.SetDefault("http.addr", "127.0.0.1:9094")
	viper.SetDefault("http.port", "9094")
