...
var file_fightbettr_proto_depIdxs = []int32{
	...
	31, // 9: FightResultResponse.response:type_name -> google.protobuf.Empty
	23, // 10: Event.fights:type_name -> Fight
	27, // 11: Fighter.stats:type_name -> FighterStats
	26, // 12: FightersResponse.fighters:type_name -> Fighter
	0,  // 13: AuthService.Register:input_type -> RegisterRequest
	2,  // 14: AuthService.RegisterConfirm:input_type -> RegisterConfirmRequest
	4,  // 15: AuthService.Login:input_type -> AuthenticateRequest
	6,  // 16: AuthService.PasswordReset:input_type -> PasswordResetRequest
	8,  // 17: AuthService.PasswordRecover:input_type -> PasswordRecoveryRequest
	10, // 18: AuthService.Profile:input_type -> ProfileRequest
	...
	28, // 24: FightersService.SearchFightersCount:input_type -> FightersRequest
	28, // 25: FightersService.SearchFighters:input_type -> FightersRequest
	1,  // 26: AuthService.Register:output_type -> RegisterResponse
	3,  // 27: AuthService.RegisterConfirm:output_type -> RegisterConfirmResponse
	5,  // 28: AuthService.Login:output_type -> AuthenticateResponse
	7,  // 29: AuthService.PasswordReset:output_type -> PasswordResetResponse
	9,  // 30: AuthService.PasswordRecover:output_type -> PasswordRecoveryResponse
	11, // 31: AuthService.Profile:output_type -> ProfileResponse
	14, // 32: EventService.CreateEvent:output_type -> CreateEventResponse
	16, // 33: EventService.GetEvents:output_type -> GetEventsResponse
	18, // 34: EventService.CreateBet:output_type -> CreateBetResponse
	20, // 35: EventService.GetBets:output_type -> BetsResponse
	22, // 36: EventService.SetResult:output_type -> FightResultResponse
	30, // 37: FightersService.SearchFightersCount:output_type -> FightersCountResponse
	29, // 38: FightersService.SearchFighters:output_type -> FightersResponse
